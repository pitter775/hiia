...
return [
    ...
    */
    ...
    | Isso ajuda a tornar as mensagens de um atributo específico mais claras.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para substituir o
    | placeholder dos atributos por algo mais legível, como "E-Mail" em
    | vez de "email". Isso torna nossa mensagem mais expressiva.
    |
    */
