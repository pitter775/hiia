...
!(function() {
        ...
        Jr = (e, t = 4, n = !0, o = !0) => {
            const r = ((e, t) => (t <= 0 ? "" : new Array(t + 1).join(" ")))(0, t),
                ...
                a = Y(
                    ...
                    { pcIsSpace: Qr(t), str: e.str + t }, { pcIsSpace: !1, str: "" }
                );
            return a.str;
        },
        Zr = (e, t) =>
        ...
        Ds = (e, t) => {
            ...
            const c = {
                parse: (t) => {
                    ...
                    if (t) {
                        for (t = (t = t.replace(/[\u0000-\u001F]/g, "")).replace(/\\[\"\';:\uFEFF]/g, b).replace(/\"[^\"]+\"|\'[^\']+\'/g, (e) => e.replace(/[;:]/g, b));
                            (l = o.exec(t));)
        ...
        Qs = (e, t = {}) => {
            ...
            const a = Xo.forElement(fn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
                ...
                O = (e) => {
                    ...
                    return (
                        (t = A(o, "width")),
                        (n = A(o, "height")), -1 === t.indexOf("px") && (t = 0), -1 === n.indexOf("px") && (n = 0), { w: parseInt(t, 10) || o.offsetWidth || o.clientWidth, h: parseInt(n, 10) || o.offsetHeight || o.clientHeight }
                    );
                },
                T = (e, t) => {
                    if (!e) return !1;
                ...
                Q = {
                    ...
                    createFragment: (t) => {
                        ...
                        for (r.appendChild(o), t && (o.innerHTML = t);
                            (n = o.firstChild);) r.appendChild(n);
    ...
    const wa = (e) => {
        ...
        Za = (e) => {
            ...
            return (
                (t = n.length > 0 ? Ra(n[0]) : Ra(e.getBoundingClientRect())), !Xa(e) && qa(e) && Ja(t) ?
                ((e) => {
    ...
    const ni = (e, t) => {
        ...
        gi = (e, t, n, o, r) => {
            ...
            for (
                ...
                ((l = s.childNodes), a >= l.length && l.length && ((d = 1), (a = Math.max(0, l.length - 1))), i.push(e.nodeIndex(l[a], n) + d)); s && s !== c; s = s.parentNode
            )
    ...
    const Ni = (e) => "inline-command" === e.type || "inline-format" === e.type,
        ...
        Wd = (e, t, n, o, r) => {
            ...
            if ($d(t)) {
                ...
                for (;
                    (e = qd(s.prev.bind(s), r));)
                    if (n(e)) return e;
            }
            if (Hd(t)) {
                if (a && n((e = qd(s.next.bind(s), !0)))) return e;
                for (;
                    (e = qd(s.next.bind(s), r));)
                    if (n(e)) return e;
            }
            return null;
        },
    ...
    const Wc = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        Tu = (e, t, n, o = !1) => {
            ...
            return (
                ...
                Co(a) && ((i = l.nodeIndex(a) + 1), (a = a.parentNode)), { startContainer: r, startOffset: s, endContainer: a, endOffset: i }
            );
        },
        Bu = (e, t, n) => {
    ...
    const fm = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
        ...
        Mm = (e) => {
            ...
            return (
                ...
                (Ro(t) && n > 0 && n < t.nodeValue.length && ((t = Lm(t, n)), (n = 0)), Ro(o) && r > 0 && r < o.nodeValue.length && ((o = Lm(o, r).previousSibling), (r = o.nodeValue.length))), { startContainer: t, startOffset: n, endContainer: o, endOffset: r }
            );
        },
            ...
            if (
                (!0 === n.paste &&
                    ...
                    ((e) => {
                        let t = e;
                        for (;
                            (t = t.walk());) 1 === t.type && t.attr("data-mce-fragment", "1");
                    })(h),
                    (a = h.lastChild),
        ...
        sv = (function e() {
            ...
            var T,
                ...
                ke = function(e) {
                    ...
                    ((e && "object" === ab(e)) || (e = {}),
                        ...
                        ae &&
                        ((z = Lb({}, cb($b))),
                            (V = []), !0 === ae.html && (Lb(z, Fb), Lb(V, qb)), !0 === ae.svg && (Lb(z, Ub), Lb(V, Wb), Lb(V, Gb)), !0 === ae.svgFilters && (Lb(z, zb), Lb(V, Wb), Lb(V, Gb)), !0 === ae.mathMl && (Lb(z, Vb), Lb(V, Kb), Lb(V, Gb))),
            ...
            var Ae = function(e) {
                ...
                Ie = function(e) {
                    ...
                    return e instanceof l && !Ae(e) ?
                        ...
                        (X && 3 === e.nodeType && ((t = e.textContent), (t = Ab(t, D, " ")), (t = Ab(t, P, " ")), e.textContent !== t && (Eb(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
                            Me("afterSanitizeElements", e, null), !1) :
                        (Oe(e), !0);
                },
                Fe = function(e, t, n) {
                ...
                je = function e(t) {
                    var n,
                        o = De(t);
                    for (Me("beforeSanitizeShadowDOM", t, null);
                        (n = o.nextNode());) Me("uponSanitizeShadowNode", n, null), Ie(n) || (n.content instanceof s && e(n.content), ze(n));
            ...
            return (
                (n.sanitize = function(e, r) {
                    ...
                    a && Z && Oe(a.firstChild);
                    for (var f = De(se ? e : a);
                        (d = f.nextNode());)(3 === d.nodeType && d === c) || Ie(d) || (d.content instanceof s && je(d.content), ze(d), (c = d));
                    ...
                    0 === e[0] ?
                        ...
                        (((e, t, n) => {
                                const o = ((e) => {
                                    ...
                                    for (e && (n.innerHTML = e);
                                        (t = n.firstChild);) o.appendChild(t);
                                    return o;
                                })(t);
                    ...
                    getNode: () =>
                        ((e, t) => {
                            ...
                            const s = t.startOffset,
                                a = t.endOffset;
                            return (
                                (n = t.commonAncestorContainer), !t.collapsed &&
        ...
        dC = (e) => {
            const t = ((e) => {
                    ...
                    return (
                        ...
                        n(oC()),
                        n(Ol(e)), { get: (e) => (C(e) ? t[e] : t), has: (e) => xe(t, e), register: n, unregister: (e) => (e && t[e] && delete t[e], t) }
                    );
                })(e),
                n = ea(null);
            return (
            ...
            insert: (e, t) => {
                ...
                const u = e.dom,
                    ...
                    v = (e) => {
                        ...
                        const i = new Qo(o, s);
                        for (Ro(o) && (e && 0 === a ? i.prev() : e || a !== o.nodeValue.length || i.next());
                            (t = i.current());) {
                            if (Co(t)) {
    ...
    const W_ = N("x-tinymce/html"),
        ...
        eE(e, [
            ...
            /<!--StartFragment-->|<!--EndFragment-->/g, [/( ?)<span class="Apple-converted-space">\u00a0<\/span>( ?)/g, (e, t, n) => (t || n ? fr : " ")],
                    ...
                    return {
                        create: () =>
                            ((e, t) => {
                                ...
                                const s = n.add(
                                    e.getBody(),
                                    "div", { id: "mcepastebin", class: "mce-pastebin", contentEditable: !0, "data-mce-bogus": "all", style: "position: fixed; top: 50%; width: 10px; height: 10px; overflow: hidden; opacity: 0" },
                                    X_
                                );
                    ...
                    const t = e.dom,
                        ...
                        r = (s, a) => {
                            if (
                                ...
                                return;
                            const i = e.getBody(),
                                l = !((e) => gC(e) && !(pC(e) || ("keyup" === e.type && 229 === e.keyCode)))(s) &&
                                ((e, t, n) => {
                                    if (os(fn(t), !1)) {
            ...
            unbindAllNativeEvents() {
                ...
                e.delegates &&
                    (fe(e.delegates, (t, n) => {
                        ...
                        delete e.delegates), !e.inline && t && n && ((t.onload = null), n.unbind(e.getWin()), n.unbind(e.getDoc())),
        ...
        save(e) {
            ...
            if (r && t.initialized && !t.removed)
                return (
                    ...
                    (e.element = r = null), !1 !== e.set_dirty && t.setDirty(!1),
                    n
                );
        }
        setContent(e, t) {
            ...
            ((e) => {
                if (!e.removed) {
                    ...
                    o && e.save({ is_removing: !0 }),
                        ...
                        e.editorManager.remove(e), !e.inline &&
                        o &&
                        ((e) => {
                ...
                const s = () => {
                    ...
                    VR.unbind(window, "ready", s),
                        ...
                        HR(i, (s) => {
                            ...
                            $y("Could not initialize inline editor on invalid inline target element", s): ((e, o, s) => {
